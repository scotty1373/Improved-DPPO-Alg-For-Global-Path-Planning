...
class PPO:
    def __init__(self, frame_overlay, state_length, action_dim, batch_size, overlay, device, logger=None, root=True):
        ...
        self.c_sch = torch.optim.lr_scheduler.MultiStepLR(self.c_opt, milestones=[80, 320], gamma=0.1)
        self.a_sch = torch.optim.lr_scheduler.MultiStepLR(self.a_opt, milestones=[70, 300], gamma=0.1)
